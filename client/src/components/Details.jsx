...
function Details() {
    ...
    async function getFoodById() {
        ...
        try {
            const res = await axios.get(`http://localhost:8002/getFoodById/${id}`)
    ...
    async function getSpecificationByProductId() {
        ...
        try {
            const res = await axios.get(`http://localhost:8002/getSpecificationByProductId`, {
                params: { foodId }
            })
    ...
    async function getAllOrders() {
        ...
        try {
            ...
            const res = await axios.get("http://localhost:8002/getAllOrders")
