...
function ExploreMore() {
    ...
    async function handle_food_fetch() {
        ...
        try {
            ...
            const res = await axios.get("https://mern-food-ordering-app-8.onrender.com/allFood")
    ...
    async function handle_search(e) {
        ...
        try {
            ...
            const res = await axios.get(`https://mern-food-ordering-app-8.onrender.com/foodSearch?term=${searchTerm}`)
    ...
    async function handle_remove(id) {
        ...
        try {
            ...
            const res = await axios.delete(`https://mern-food-ordering-app-8.onrender.com/delete_food?id=${id}`)
