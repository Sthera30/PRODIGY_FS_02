...
function Employee() {
    ...
    async function handle_submit(e) {
        ...
        try {
            ...
            const res = await axios.post(`https://prodigy-fs-02-backend.vercel.app/createEmployee`, { name, email, gender, dob, maritalStatus, department, position, password, confirmPassword }, {withCredentials: true})
